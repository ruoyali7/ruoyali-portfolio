...
export default function Home() {
  return <>
    ...
    <main>
      ...
      <section className="contact-section"><div className="contact-copy"><p className="eyebrow">Let&apos;s connect</p><h2>Building the next<br/><em>creative system?</em></h2><div className="contact-links"><a href="mailto:ruoyali1020@gmail.com">ruoyali1020@gmail.com ↗</a><a href="https://github.com/ruoyali7" target="_blank" rel="noreferrer">GitHub ↗</a><a href="/ruoya-li-resume.pdf" target="_blank" rel="noreferrer">Resume ↗</a><a href="/ruoya-portfolio.pdf" target="_blank" rel="noreferrer">Portfolio PDF ↗</a></div></div><aside className="linkedin-profile"><p className="eyebrow">Professional profile</p><div className="linkedin-badge"><div className="badge-base LI-profile-badge" data-locale="en_US" data-size="medium" data-theme="dark" data-type="HORIZONTAL" data-vanity="ruoya-li" data-version="v1"><a className="badge-base__link LI-simple-link" href="https://www.linkedin.com/in/ruoya-li?trk=profile-badge">Ruoya Li</a></div></div><a className="linkedin-fallback" href="https://www.linkedin.com/in/ruoya-li/" target="_blank" rel="noreferrer">View LinkedIn profile ↗</a></aside></section>
    </main>
